...
public class StatisticsListener implements PcapHandlerListener {
    ...
    private IntList goosePacketNum = new IntList(600);
    private IntList mmsPacketNum = new IntList(600);
    private IntList smvPacketNum = new IntList(600);
    private IntList otherPacketNum = new IntList(600);
    private IntList allPacketNum = new IntList(600);
    private IntList gooseBitNum = new IntList(600);
    private IntList mmsBitNum = new IntList(600);
    private IntList smvBitNum = new IntList(600);
    private IntList otherBitNum = new IntList(600);
    private IntList allBitNum = new IntList(600);
