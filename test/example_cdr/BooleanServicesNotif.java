...
public class BooleanServicesNotif extends OctetString
{
	/**
	...
	*/
	public
	BooleanServicesNotif(String name)
	{
		super(name);
	}
	...
	*/
	public
	BooleanServicesNotif(byte[] value)
	{
		super(value);
	}
	...
	*/
	public
	BooleanServicesNotif(String name, byte[] value)
	{
		super(name, value);
	}
}
