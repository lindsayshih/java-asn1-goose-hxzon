...
public class Integer_less_constraint extends ASN1Integer
{
	/**
	...
	*/
	public
	Integer_less_constraint(String name)
	{
		super();
		setName(name);
	}
	...
	*/
	public
	Integer_less_constraint(long value)
	{
		super();
		setValue(value);
	}
	...
	*/
	public
	Integer_less_constraint(String name, long value)
	{
		super();
		setValue(value);
		setName(name);
