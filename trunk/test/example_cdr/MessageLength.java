...
public class MessageLength extends ASN1Integer
{
	/**
	...
	*/
	...
	public static final long  max = 640;
	...
	*/
	public
	MessageLength(String name, long value)
	{
		super("min",min,"max",max);
		setValue(value);
		setName(name);
