...
//		}
//	}
    public static final String[] numberName = new String[] { "--", "confirmed-requestPDU", "confirmed-responsePDU", "confirmed-errorPDU", "unconfirmedPDU", "pdu-error", "cancel-requestPDU",
            "cancel-responsePDU", "cancel-errorPDU", "conclude-requestPDU", "conclude-responsePDU", "conclude-errorPDU" };
    public static final String[][] numberDescription = new String[][] { new String[] { "--" },
//		confirmed-requestPDU		[1] IMPLICIT INTEGER 
//		{
//		other(0),
//		unrecognized-service(1),
