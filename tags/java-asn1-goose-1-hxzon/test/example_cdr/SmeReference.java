...
public class SmeReference extends ASN1Integer
{
	/**
	...
	*/
	...
	public static final long  max = 2147483647;
	...
	*/
	public
	SmeReference(String name, long value)
	{
		super("min",min,"max",max);
		setValue(value);
		setName(name);
