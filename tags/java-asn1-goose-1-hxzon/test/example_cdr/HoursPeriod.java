...
public class HoursPeriod extends ASN1Integer
{
	/**
	...
	*/
	...
	public static final long  max = 8760;
	...
	*/
	public
	HoursPeriod(String name, long value)
	{
		super("min",min,"max",max);
		setValue(value);
		setName(name);
