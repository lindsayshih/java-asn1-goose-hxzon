...
public class C7PointCode extends ASN1Integer
{
	/**
	...
	*/
	...
	public static final long  max = 16777215;
	...
	*/
	public
	C7PointCode(String name, long value)
	{
		super("max",max);
		setValue(value);
		setName(name);
