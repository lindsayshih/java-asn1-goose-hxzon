...
public class EmsBytesCompressed extends ASN1Integer
{
	/**
	...
	*/
	...
	public static final long  max = 35700;
	...
	*/
	public
	EmsBytesCompressed(String name)
	{
		super("min",min,"max",max);
		setName(name);
	}
	...
	*/
	public
	EmsBytesCompressed(String name, long value)
	{
		super("min",min,"max",max);
		setValue(value);
		setName(name);
