...
public class GetAlarmSummaryResponse extends BerSequence {
...
//	}
	public BerNode create(int tag, BerInputStream stream) {
		switch (tag) {
		case Tag.CONTEXT | 0:
			return Asn1Utils.createBerSequenceOf("listOfAlarmSummary", "listOfAlarmSummary", tag, stream, AlarmSummary.class);
		case Tag.CONTEXT | 1:
