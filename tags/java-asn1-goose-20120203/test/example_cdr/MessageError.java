...
public class MessageError extends ASN1Integer
{
	/**
	...
	*/
	...
	public static final long  max = 65534;
	...
	*/
	public
	MessageError(String name, long value)
	{
		super("min",min,"max",max);
		setValue(value);
		setName(name);
